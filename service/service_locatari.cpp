...
void ServiceLocatari::add_observer(Observer* observer)
{
    lista_notificare.add_observer(observer);
}

void ServiceLocatari::remove_observer(Observer* observer)
{
    lista_notificare.remove_observer(observer);
}